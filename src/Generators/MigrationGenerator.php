...
namespace Eos\Repository\Generators;

use Eos\Repository\Generators\Migrations\NameParser;
use Eos\Repository\Generators\Migrations\SchemaParser;

/**
 * Class MigrationGenerator
 * @package Eos\Repository\Generators
 */
